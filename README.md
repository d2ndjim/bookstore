# BOOKSTORE PROJECT
> This project uses react, redux and API to keep track of the adding and removal of books to and from a bookstore.
...
```
git clone  <https://github.com/d2ndjim/bookstore.git>
```
